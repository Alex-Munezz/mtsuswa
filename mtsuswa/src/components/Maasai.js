...
export default function Hiking(){
    ...
    return (
        <div>
            <Navbar />
            <br /><br />
      <h1 className="text-5xl flex justify-center mt-10 maasaih1">| Services  &#10148;  Vibrant Maasai Culture</h1>
     <br /><br /><br />
     <div className='hike'>
     <img src={Maasai} alt="maasai" className='maasaiImg'/><br /><br />
     <p className='text-2xl ml-5 maasaiP'>  Discover the Maasai Culture: Tradition and Harmony.
        Enter the world of the Maasai,<br /> where tradition dances 
        with nature. Nomads of the savannah, they honor their <br />legacy 
        through vibrant rituals and colorful beadwork. As guardians of 
        the wilderness, <br />they embody resilience and grace.
        In their culture, unity and heritage thrive amidst the changing winds of time.</p>
          <br /><br />
...
<img src={HikingImg} alt='hiking' className='h' />
  <div class="p-6">
    ...
    Embark on a journey of exploration and adventure with our
          premier hiking services.<br /> At Mt Suswa Camping, we're dedicated to providing you with unforgettable hiking ......
    </p>
  </div>
  <div class="p-6 pt-0">
